...
public class Main_EJ01 {
	...
	public static void main(String[] args) {
		...
		int i = JOptionPane.showOptionDialog(null, "El area de que figura quieres calcular?", "Calculadora de area",
				JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, options, options[3]);

		if (i == JOptionPane.CLOSED_OPTION)
			i = 3; // Controla el cierre del JOPane
	...
	private static String calculadorArea(String opciones) {
		...
		if (opciones.equals("Circulo"))
			return areaCirculo();
		if (opciones.equals("Triangulo"))
			return areaTriangulo();
		if (opciones.equals("Cuadrado"))
			return areaCuadrado();
